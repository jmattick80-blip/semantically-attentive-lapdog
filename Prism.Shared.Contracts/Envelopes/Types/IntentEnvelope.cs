...
namespace Prism.Shared.Contracts.Envelopes.Types
{
    ...
    public abstract class IntentEnvelope : PrismSystemEnvelopeBase, IIntentEnvelope
    {
        ...
        public List<ITrait> Traits { get; protected internal set; } = new();

        public PayloadPackage PayloadPackage { get; set; }

        // Emotional context
        public Dictionary<string, string> ToneTags { get; protected internal set; } = new();
        public Dictionary<string, double> LayerWeights { get; protected internal set; } = new();
        public List<RippleEvent> RippleHistory { get; protected internal set; } = new();
        ...
        public void ClearNotes() => _validationNotes.Clear();
